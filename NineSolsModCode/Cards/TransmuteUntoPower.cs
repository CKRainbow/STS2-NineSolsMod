...
public class TransmuteUntoPower() : NineSolsModCard(0, CardType.Power, CardRarity.Token, TargetType.Self), IChoosable
{
    protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay play)
    {
        await PowerCmd.Apply<TransmuteUntoPowerPower>(choiceContext, Owner.Creature, 1, Owner.Creature, this, false);
    }
